...
const thankyou=()=>{
    return(
      <div>
        ...
        <Header />
        <Heroslider texttwoclass={'!bg-[linear-gradient(0deg,_#FAECC9_0%,_#CCAB64_100%)] !bg-clip-text !text-transparent xl:!text-[130px] !font-bold !font-poppins '} thankyou={true} main={true} cloud={false} Home={false} bottom={'hidden'} overlay={true} texttwo='Thankyou' />
