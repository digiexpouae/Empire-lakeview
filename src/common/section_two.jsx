...
<div className=" w-full md:flex md:flex-row flex flex-col gap-[40px] lg:gap-[80px]">
        <div className="flex flex-col md:w-[50%] lg:w-[40%] xl:gap-0 lg:gap-[45px] ">
         ...
         ref={ref1} >
            ...
            {head}
              ...
              <LottieIcons className={`element ${home ?'opacity-100':'opacity-0'}`} className2={`text-center md:w-[120px] !text-[10px]   ${icontext}`} ref={ref3} amenities={amenities} iconsize={'h-[70px] w-[70px] md:w-[50px] md:h-[50px]'}  className1={`grid grid-cols-2 lg:flex  md:grid-cols-3 gap-8 lg:gap-2  mt-8 lg:mt-40 xl:mt-30 ${home ?'opacity-100':'opacity-0'}`}/></div>
        ...
        <div className=" md:w-[50%] lg:w-[60%]"> <div className={`md:p-6 sm:p-8 lg:p-0 flex flex-col items-start lg:h-[280px] gap-4 ${home ?'opacity-100':'opacity-0'}`} ref={ref2}>
            ...
            <p 
              className={`text-[18px] lg:text-[20px] animate-fade-up text-white leading-5 my-heading md:leading-7 font-light ${classNamep}`}
            >
             {text}
            </p>
            {btn &&
