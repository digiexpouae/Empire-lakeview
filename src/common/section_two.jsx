        ...
        <div className="flex flex-col md:w-[50%] lg:w-[40%] xl:gap-0 lg:gap-[45px] ">
         ...
         ref={ref1} >
            ...
            {head}
              ...
              <LottieIcons className={'element opacity-0'} className2={'text-center md:w-[120px] '} ref={ref3} amenities={amenities} iconsize={'w-[50px] h-[50px]'}  className1={'grid grid-cols-2 lg:grid-cols-5 md:grid-cols-3 gap-8 lg:gap-36  mt-8 lg:mt-20 opacity-0'}/></div>
