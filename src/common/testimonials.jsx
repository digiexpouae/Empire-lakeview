...
const testimonials = () => {
  ...
  return (
    <div className='w-full h-[300px]  md:h-[600px] flex items-center justify-center'>
      <div className='flex items-center justify-center md:gap-24 w-[90%] h-[70%] md:w-[70%]  bg-white rounded-2xl'>
