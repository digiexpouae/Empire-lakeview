...
const heroslider = ({thankyou,p1,p2,p3,garden,textone,lakeview,garden_im,texttwo,textthree,main_im,main,im1,im2,overlay,className1,className2,className,className3,bottom,cloud,img,Home,texttwoclass}) => {
    const boxref=useRef()
