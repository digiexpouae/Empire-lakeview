...
const Places = ({ center_position, Name, markers, Main_marker }) => {
  ...
  return (
    <div className='bg-[#0E1527] w-full md:pt-24 pt-20 text-white !h-[100vh]' ref={sectionref}>
      <div className='w-full h-full relative'>
        <div className='absolute inset-0 w-full h-full'>
          <Map 
            className='z-50' 
            carcontainer={carWrapperRef} 
    ...
    <div className='md:!w-[127px] !w-[62px] !h-[50px] md:!h-[72px] absolute left-[20%] rotate-180 z-30'><Image src={car} objectFit='cover' fill  className='transition-transform duration-700 ease-in-out'>
    </div>
