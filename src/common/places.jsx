...
const carWrapperRef=useRef(null)
 ...
 return(
 <div className=' bg-[#0E1527] w-full   text-white !h-[90vh]'  ref={sectionref}>
      <div className='flex flex-col items-center justify-center gap-[100px]  w-full lg:mt-[20px] mt-[50px] ' >
        <div className='flex flex-col items-center justify-center w-full ' >
        <h2 className='my-heading lg:text-[70px] md:text-[50px] text-[34px]  font-bold' >In The Heart Of It All</h2>
