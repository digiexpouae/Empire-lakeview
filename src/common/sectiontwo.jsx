...
return (<>
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:h-[700px] flex flex-col items-center justify-center w-[80vw] scrollbar-hide ">
  ...
  bg-gradient-to-r from-[#CCAB64] to-[#FAECC9]
    hover:from-[#E5C98C] hover:to-[#E5C98C] text-gray-800 w-[180px] lg:px-2 py-1 rounded-full transition-colors duration-300  transform text-sm lg:text-base whitespace-nowrap">Download Floor Plan</button>
      ...
      <div className="w-full flex items-start justify-start  ">
       <div className={`grid ${btn? 'lg:grid-cols-4 grid-cols-2 ':'md:grid-cols-4 grid-cols-2'} lg:grid-cols-4 grid-cols-2 gap-8 lg:gap-10 mt-8 lg:mt-20 ${btn? 'w-[60%]':'md:w-[100%] w-[100%] xl:w-[80%]'}`} ref={ref3}>
              {amenities.map((amenity, index) => (
                <div 
                  key={index} 
                  className=" flex flex-col  justify-center p-2 bg-white  rounded-[13px] animate-fade-up-delayed h-[130px] w-[130px] md:h-[150px] md:w-[140px] lg:h-[180px] lg:w-[180px] gap-[5px] md:gap-[10px] "
