...
return (
  ...
  <div className={`w-full ${className1} relative `} ref={containerRef}>
    ...
    {/* Mobile Slider */}
    <div className='md:hidden w-full py-8 relative' style={{ minHeight: '500px' }}>
      <Swiper
        slidesPerView={1.2}
        spaceBetween={15}
          ...
          {ima.map((elem, index) => (
            ...
            >
              ...
              <div className='absolute left-3 bottom-6 z-40'>
                ...
                <a className='button flex items-center justify-center !py-[3px] !w-[90px] md:!w-[120px] !text-[8px] md:!text-[15px]' href={elem.link}>
                  View projects
                </a>
              </div>
            </div>
