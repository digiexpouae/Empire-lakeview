              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 flex flex-col max-w-[80%] justify-center p-6 text-white z-10">
                  ...
                  <a
                    ...
                    className="mt-36 px-5 py-2 text-black  bg-[linear-gradient(90deg,#CCAB64_0%,#FAECC9_100%)]  border max-w-[120px] border-white text-sm rounded-md hover:bg-white hover:text-black transition"
                  >
                    Read More
                  </a>
                </div>
