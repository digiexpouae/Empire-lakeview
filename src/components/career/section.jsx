...
const Section = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-[#0E1527] w-full text-white py-12 px-4">
      <h1 className="text-[30px] md:text-[45px] text-center font-bold leading-tight mb-10">
        Life at Empire
      </h1>
