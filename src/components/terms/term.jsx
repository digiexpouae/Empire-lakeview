      ...
      <div className="w-full  bg-black pt-40">
        ...
        <section className="py-10 w-full px-4 mx-auto md:max-w-5xl text-white font-secondary text-base rich-text-block">
          <table className="w-full border-separate border-spacing-y-4">
            <tbody>
              <tr>
                <td className="align-top  text-white font-medium">
                  We, us, our or Empire
                </td>
                <td className="align-top text-white">
                  Empire Development and any of its affiliates and/or subsidiaries.
                </td>
              </tr>
              <tr>
                <td className="align-top pr-4 text-white font-medium">
                  You, you and yours
                </td>
                <td className="align-top text-white">
          ...
          <p>
            These are general Terms and Conditions of Empire Development (the ‘Company’) governing
          ...
          <p>
            ...
            eligibility to the products and services offered on the website is subject to Empire
          ...
          <p className="mt-4 font-bold">Copyright © Empire Development. All Rights Reserved.</p>
          <p>
            Copyright in the pages and in the screens displaying the pages, along with the
            information and material therein and in their arrangement, is owned by Empire
          ...
          <p>
            Empire Development, its subsidiaries, affiliates, contractors and/or participating
          ...
          <p>
            Under no circumstance will Empire be liable for any features, functions (programming
            ...
            data/information, or any loss whether foreseen, foreseeable, known or otherwise). Empire
          ...
          <p>
            All information submitted to Empire via this site shall be deemed (and remain) the
            property of Empire, which shall be free to use, for any purpose, any ideas, concepts,
            know-how or techniques contained in information, a visitor to this site provides Empire
            through this site. Empire shall not be subject to any obligations of confidentiality or
            privacy regarding information submitted, except as agreed by Empire or as otherwise
