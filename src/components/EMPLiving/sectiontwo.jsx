...
const sectiontwo = () => {
    const textpara="Empire Living sets a new benchmark for modern luxury in JVC. Each apartment by Empire Developments features beautiful designs and smart home tech. These innovations simplify life. Residents can enjoy rooftop recreation areas with city views, wellness centers, and gardens. It's an ideal place for modern families and investors who want to look ahead."
  return (
