...
<div className='w-full relative md:block hidden md:h-screen h-[500px] '>
        <Header className='nav-menu absolute z-50'/>
            <Heroslider className={'top-[15%]'} textthree={'Empire'} className3={'top-2 lg:top-5 md:top-9 xl:top-12'} texttwo={'Livings'} main={main} bottom={'bottom-0 !h-[240px]  md:!h-[470px] !w-[85%] md:!w-[70%] lg:!w-[50%]'} main_im={Hero} cloud={cloud} im1={im} im2={im}/>
