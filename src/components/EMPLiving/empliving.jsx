  ...
  const images = [
    {
      ...
      tex1: 'Studio',
      tex2: 'SIZE RANGE: 352.41 TO 436.48 SQ.FT ',
    ...
    },
    {
      ...
      tex1: '1 Bed',
      tex2: 'SIZE RANGE: 580.61 TO 721.94 SQ.FT',
    ...
    },
    {
      ...
      tex2: 'SIZE RANGE: 622.05 TO 1085.64 SQ.FT',
      link1: 'https://empire-lakeview.vercel.app/360/empirelivings/empliv1bed/index.htm',
      link2: '/contact',
    },
