...
const heroslider = () => {
    ...
    useEffect(() => {
        ...
        mm.add("(max-width: 768px)", () => {
          ...
          gsap.fromTo(
            box_Two.current,
            { x: 300, opacity: 0 }, // Shorter distance for mobile
            {
              x: 150,
              opacity: 1,
              duration: 1.5,
...
<div className='absolute lg:top-11 md:top-[2%] top-9 lg:left-[16%] md:left-[15vw] left-[12%]  opacity-0 'ref={text1} >
...
<div className=' absolute w-full opacity-0 md:top-auto top-10'ref={text2} >
...
<div className='md:right-34 right-[5%]  absolute xl:top-[38%] lg:top-[34%] md:top-[29%] top-[29vw] opacity-0 'ref={text3} >
...
<div className='relative h-[400px] md:h-[500px] z-50 opacity-0 ' ref={im}>
<Image src={empire}  height={421} width={782} className='absolute lg:left-[9%] xl:left-[18%] bottom-[-60px] md:bottom-[-200px] z-40 md:h-auto h-full ' /></div>
...
designed for lifestyle
 ...
 <div ref={box_Two} className="absolute top-0 z-50 left-0   opacity-0 "> {/* <<< starts offscreen */}
          <Image src={cloud} alt="Cloud" objectFit='cover' />
        </div>

 <div className='absolute md:bottom-0 bottom-36 z-50 left-[10%] opacity-0' ref={box_three}>
