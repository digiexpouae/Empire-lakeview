    ...
    <div className="flex flex-col items-center justify-center  ">
      ...
      {!thirdImageVisible && !fourthImageVisible && (
        <div ref={thirdImageRef} className="relative w-full">
          <Image src={Mask3} alt="Mask3" objectFit="cover" />
          <div className="overlay absolute top-0 left-0 right-0 bottom-0 flex w-full  bg-[linear-gradient(270deg,rgba(0,46,60,0)52.53%,rgba(0,46,60,0.9)80.55%),linear-gradient(0deg,rgba(0,46,60,0.3),rgba(0,46,60,0.3))] z-10">
            <div className="absolute left-20 z-10 flex flex-col justify-center h-full gap-3 w-[295px]">
            
              <h2 className="text-[80px] text-white my-heading font-bold">1 Bed</h2>
              <span className="text-white my-heading">
                Size: 2633.68 SQ.FT. To 2682.94 SQ.FT.
              </span>
              <div className='flex gap-3'>
                ...
                <button className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 px-4 py-2 rounded-full transition-colors duration-300 text-center text-base">
                  Contact us
                </button>
              </div>
            </div >
